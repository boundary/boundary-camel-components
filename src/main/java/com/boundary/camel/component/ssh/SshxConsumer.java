...
public class SshxConsumer extends ScheduledPollConsumer {
    private final SshxEndpoint endpoint;

    public SshxConsumer(SshxEndpoint endpoint, Processor processor) {
