...
public class SshxEndpoint extends ScheduledPollEndpoint {
    ...
    @UriParam
    private SshxConfiguration sshxConfiguration;

    public SshxEndpoint() {
    }

    public SshxEndpoint(String uri, SshxComponent component) {
        super(uri, component);
    }

    public SshxEndpoint(String uri, SshxComponent component, SshxConfiguration configuration) {
        super(uri, component);
        this.sshxConfiguration = configuration;
    }

    @Override
    public Producer createProducer() throws Exception {
        return new SshxProducer(this);
    }

    @Override
    public Consumer createConsumer(Processor processor) throws Exception {
        SshxConsumer consumer = new SshxConsumer(this, processor);
